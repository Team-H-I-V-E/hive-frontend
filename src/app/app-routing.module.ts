...
const routes: Routes = [
  ...
  { path: 'home', loadChildren: () => import('./pages/home/home.module').then(m => m.HomeComponentModule) },

  { path: 'heritage', loadChildren: () => import('./pages/heritage/heritage.module').then(m => m.HeritageComponentModule) },

  { path: 'panorama', loadChildren: () => import('./pages/panorama/panorama.module').then(m => m.PanoramaComponentModule) },

  { path: 'arexplore', loadChildren: () => import('./pages/arexplore/arexplore.module').then(m => m.ARExploreComponentModule) },
